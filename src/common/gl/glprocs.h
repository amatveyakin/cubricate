...
typedef struct {
  ...
  //user added
  GLvoid* (APIENTRY *MapBufferRange) (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access);
  ...
  void (APIENTRY *GenFramebuffers) (GLsizei n, GLuint *ids);
  ...
  void (APIENTRY *GetProgramInfoLog) (GLuint program, GLsizei maxLength, GLsizei *length, GLchar *infoLog);
  ...
  void (APIENTRY *GetShaderInfoLog) (GLuint shader, GLsizei maxLength, GLsizei *length, GLchar *infoLog);
...
// user added
#define glMapBufferRange                  (_GET_TLS_PROCTABLE()->MapBufferRange)
#define glFramebufferTexture2D            (_GET_TLS_PROCTABLE()->FramebufferTexture2D)
#define glBindFramebuffer                 (_GET_TLS_PROCTABLE()->BindFramebuffer)
#define glGenFramebuffers                 (_GET_TLS_PROCTABLE()->GenFramebuffers)
...
#define glBindVertexArray                 (_GET_TLS_PROCTABLE()->BindVertexArray)
#define glGenVertexArrays                 (_GET_TLS_PROCTABLE()->GenVertexArrays)
...
#define glDeleteVertexArrays              (_GET_TLS_PROCTABLE()->DeleteVertexArrays)
#define glDeleteProgram                   (_GET_TLS_PROCTABLE()->DeleteProgram)
#define glUniform1i                       (_GET_TLS_PROCTABLE()->Uniform1i)
#define glGenerateMipmap                  (_GET_TLS_PROCTABLE()->GenerateMipmap)
#define glTexBuffer                       (_GET_TLS_PROCTABLE()->TexBuffer)
