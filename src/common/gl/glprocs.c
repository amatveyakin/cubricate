...
static GLvoid* APIENTRY InitMapBufferRange (GLenum target, GLintptr offset, GLsizeiptr length, GLbitfield access)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glMapBufferRange");
	...
	glMapBufferRange = extproc;

	return glMapBufferRange(target, offset, length, access);
}

static void APIENTRY InitFramebufferTexture2D (GLenum target, GLenum attachment, GLenum textarget, GLuint texture, GLint level)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glFramebufferTexture2D");
	...
	glFramebufferTexture2D = extproc;

	glFramebufferTexture2D(target, attachment, textarget, texture, level);
}

static void APIENTRY InitBindFramebuffer (GLenum target, GLuint framebuffer)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glBindFramebuffer");
	...
	glBindFramebuffer = extproc;

	glBindFramebuffer(target, framebuffer);
}

static void APIENTRY InitGenFramebuffers (GLsizei n, GLuint *ids)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glGenFramebuffers");
...
static void APIENTRY InitBindVertexArray (GLuint array)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glBindVertexArray");
	...
	glBindVertexArray = extproc;

	glBindVertexArray(array);
}

static void APIENTRY InitGenVertexArrays (GLsizei n, GLuint *arrays)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glGenVertexArrays");
...
static void APIENTRY InitDeleteVertexArrays (GLsizei n, const GLuint *arrays)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glDeleteVertexArrays");
...
static void APIENTRY InitGenerateMipmap (GLenum target)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glGenerateMipmap");
	...
	glGenerateMipmap = extproc;

	glGenerateMipmap(target);
}

static void APIENTRY InitTexBuffer (GLenum target, GLenum internalFormat, GLuint buffer)
{
	void *extproc;

	extproc = (void *) wglGetProcAddress("glTexBuffer");
...
static void APIENTRY InitGetProgramInfoLog (GLuint program, GLsizei maxLength, GLsizei *length, GLchar *infoLog)
{
	void *extproc;
...
static void APIENTRY InitGetShaderInfoLog (GLuint shader, GLsizei maxLength, GLsizei *length, GLchar *infoLog)
{
	void *extproc;
...
static GLuint APIENTRY InitCreateShader (GLenum shaderType)
{
	void *extproc;
